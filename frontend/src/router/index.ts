...
function isLiteEdition(authStore: ReturnType<typeof useAuthStore>) {
  return (
    authStore.isLiteMode || localStorage.getItem("weknora_lite_mode") === "true"
  );
}
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: "knowledge-bases/:kbId/youtube/:knowledgeId",
          name: "youtubeView",
          component: () => import("../views/knowledge/YouTubeView.vue"),
          meta: { requiresInit: true, requiresAuth: true },
        },
        {
