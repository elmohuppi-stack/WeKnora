<template>
  <!-- Mobile layout -->
  <MobileLayout v-if="uiStore.isMobile" />

  <!-- Desktop layout -->
  <div v-else class="main" ref="dropzone">
    <Menu></Menu>
    ...
    <div class="upload-mask" v-show="ismask">
      <input
        ...
        style="display: none"
        ref="uploadInput"
        accept=".pdf,.docx,.doc,.pptx,.ppt,.txt,.md,.jpg,.jpeg,.png,.csv,.xls,.xlsx"
      />
...
let uploadInput = ref();
const { t } = useI18n();
useMobile(); // Initialize mobile viewport detection
...
const CHAT_DROP_ROUTE_NAMES = new Set([
  "chat",
  "globalCreatChat",
  "kbCreatChat",
]);
