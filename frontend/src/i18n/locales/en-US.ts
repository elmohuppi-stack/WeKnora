export default {
  ...
  batchManage: {
    ...
    deleteConfirmBody:
      "Are you sure you want to delete the selected {count} conversation(s)? This action cannot be undone.",
  ...
  knowledgeBase: {
    ...
    tagDeleteDesc:
      'Delete tag "{name}"? All FAQ entries under this tag will also be deleted.',
    tagDeleteDescDoc:
      'Delete tag "{name}"? All documents under this tag will also be deleted.',
    ...
    docActionUnsupported:
      "This knowledge base type does not support this action",
    ...
    videosFilteredNoVLM:
      "Skipped {count} video file(s) (video upload is not supported)",
    ...
    unsupportedTypesHint:
      "Some document types ({types}) have no available parser engine and cannot be processed",
    ...
    importFromURLDesc: "Import via URL link",
    urlImportTip: "Add a webpage as a knowledge source",
    ...
    urlTip:
      "Supports importing various webpage contents. The system will automatically extract and parse text content from the webpage",
    importYouTube: "Import YouTube Video",
    importYouTubeTitle: "Import from YouTube",
    youtubeUrlRequired: "Please enter a YouTube video URL",
    invalidYouTubeUrl:
      "Please enter a valid YouTube URL (e.g., https://www.youtube.com/watch?v=...)",
    youtubeImportSuccess: "YouTube video imported successfully!",
    youtubeImportFailed: "YouTube video import failed!",
    youtubeUrlExists: "This YouTube video already exists",
    ...
    originalFileNotSupported:
      "This file type does not support original file view. Please download to view.",
    ...
    legacyQuestionCannotDelete:
      "Legacy format questions cannot be deleted. Please regenerate questions.",
    notInitialized:
    ...
    fileUploadEventReceived:
      "File upload event received, uploaded knowledge base ID: {uploadedKbId}, current knowledge base ID: {currentKbId}",
    matchingKnowledgeBase: "Matching knowledge base, starting file list update",
    routeParamChange:
      "Route parameter change, re-fetching knowledge base content",
    ...
    responseInterceptorData:
      "Since the response interceptor has already returned data, result is part of the response data",
    hookProcessing: "Processing according to useKnowledgeBase hook method",
    errorHandling: "Error handling",
    priorityCurrentPageKbId:
      "Priority to use knowledge base ID of current page",
    fallbackLocalStorageKbId:
      "If current page has no knowledge base ID, attempt to get knowledge base ID from settings in localStorage",
    // Additional translations for KnowledgeBaseList.vue
    createNewKnowledgeBase: "Create Knowledge Base",
    uninitializedWarning:
      "Some knowledge bases are not initialized, you need to configure model information in settings first to add knowledge documents",
    initializedStatus: "Initialized",
    notInitializedStatus: "Not Initialized",
    needSettingsFirst:
      "You need to configure model information in settings first to add knowledge",
    documents: "Documents",
    configureModelsFirst:
      "Please configure model information in settings first",
    ...
    operationNotSupportedForType:
      "This operation is not supported for the current knowledge base type",
    allFilesSkippedNoEngine:
      "All selected files were skipped due to no available parser engine",
    filesSkippedNoEngine:
      "{count} file(s) skipped due to no available parser engine",
    allUploadSuccess: "All files uploaded successfully ({count} files)",
    partialUploadSuccess:
      "Partial upload success (success: {success}, failed: {fail})",
  ...
  knowledgeStages: {
    ...
    fetchFailed:
      "Last {n} refreshes failed — data may be stale, click refresh to retry",
    ...
    rowSelectHint:
      "Click to view details; use the arrow to expand or collapse children",
    ...
    detail: {
      ...
      elapsed: "Elapsed",
      placeholderHint:
        "This stage has no detailed span record; only the inferred state is shown.",
    ...
    errorCode: {
      ...
      DOCREADER_TIMEOUT_SUGGESTION:
        "The file may be too large or the parser service is busy. Try again later or split the document.",
      DOCREADER_UNAVAILABLE: "Document parser unavailable",
      DOCREADER_UNAVAILABLE_SUGGESTION:
        "The parsing service is offline. Contact your administrator.",
      DOCREADER_PARSE_FAILED: "Document parsing failed",
      DOCREADER_PARSE_FAILED_SUGGESTION:
        "The file could not be parsed. Verify it is not corrupted.",
      CHUNKING_FAILED: "Chunking failed",
      CHUNKING_FAILED_SUGGESTION:
        "Try adjusting the chunking configuration of the knowledge base.",
      EMBEDDING_RATE_LIMIT: "Embedding service rate-limited",
      EMBEDDING_RATE_LIMIT_SUGGESTION:
        "The embedding provider is throttling requests. Retry shortly.",
      EMBEDDING_PROVIDER_FAIL: "Embedding provider error",
      EMBEDDING_PROVIDER_FAIL_SUGGESTION:
        "The embedding provider returned an error. Check provider configuration.",
      VECTORSTORE_WRITE_FAILED: "Vector store write failed",
      VECTORSTORE_WRITE_FAILED_SUGGESTION:
        "The vector store rejected the write. Check store availability.",
      MULTIMODAL_VLM_FAILED: "Image understanding failed",
      MULTIMODAL_VLM_FAILED_SUGGESTION:
        "A subset of images could not be processed. Document may still be usable.",
      MULTIMODAL_ALL_FAILED: "All images failed multimodal processing",
      MULTIMODAL_ALL_FAILED_SUGGESTION:
        "Verify the multimodal model configuration.",
      TASK_TIMEOUT: "Task exceeded maximum runtime",
      TASK_TIMEOUT_SUGGESTION:
        "The task ran longer than allowed. Retry or contact support.",
      UPSTREAM_FAILED: "Stopped because an upstream stage failed",
      UPSTREAM_FAILED_SUGGESTION:
        "A previous stage failed and prevented this step from running.",
  ...
  agent: {
    ...
    stepsCompletedWithDuration:
      "Completed <strong>{steps}</strong> step(s) in <strong>{duration}</strong>",
    title: "Agents",
    subtitle:
      "Configure and manage your agents to customize conversation behavior and capabilities",
    ...
    empty: {
      ...
      description:
        "Click the button in the top right to create your first agent",
      sharedTitle: "No shared agents yet",
      sharedDescription:
        "You can join a space or ask others to share agents with you",
    ...
    editor: {
      ...
      disabled: "Disable",
      disabledDesc:
        "When disabled, this agent will not appear in the conversation agent dropdown",
      systemPromptRequired: "System prompt is required",
      modelRequired: "Please select a model",
      rerankModelRequired:
        "ReRank model is required when using knowledge bases",
      contextsMissing:
        "Context template must contain {'{{'}contexts{'}}'} placeholder when knowledge base is enabled",
      queryMissingInContext:
        "Context template must contain {'{{'}query{'}}'} placeholder",
      knowledgeBasesMissing:
        "It is recommended to include {'{{'}knowledge_bases{'}}'} placeholder in system prompt so the model knows available knowledge bases",
      queryMissingInRewrite:
        "Rewrite user prompt must contain {'{{'}query{'}}'} placeholder",
      conversationMissing:
        "Rewrite user prompt must contain {'{{'}conversation{'}}'} placeholder",
      ...
      systemPromptPlaceholder:
        "Custom system prompt to define agent behavior and role (use {'{{'}web_search_status{'}}'} placeholder for dynamic web search behavior)",
      defaultPromptHint:
        "Leave empty to use the following default system prompt:",
      defaultContextTemplateHint:
        "Leave empty to use the following default context template:",
      ...
      welcomeMessagePlaceholder:
        "Message displayed when this agent is selected",
      ...
      rerankModelOptionalHint:
        "No RAG knowledge base in current scope, so this is optional. If a RAG knowledge base is added later, the tenant default rerank model will be used as a fallback. Configuring it explicitly is still recommended.",
      ...
      skillsConfig: "Skills",
      skillsConfigDesc:
        "Configure preloaded Skills available to the Agent for specialized domain knowledge and workflows",
      ...
      skillsInfoContent:
        "Skills are preloaded professional knowledge modules that provide domain-specific instructions, workflows, and tool support for the Agent. When enabled, the Agent will automatically load relevant knowledge when needed.",
    },
    selector: {
      title: "Select Agent",
    ...
    builtinInfo: {
      ...
      smartReasoning: {
        ...
        description:
          "ReAct reasoning framework with multi-step thinking and tool calling",
      },
      deepResearcher: {
        name: "Deep Researcher",
        description:
          "Focused on in-depth research and comprehensive analysis, capable of creating research plans, multi-dimensional information retrieval, deep thinking and providing thorough analysis reports",
      },
      dataAnalyst: {
        name: "Data Analyst",
        description:
          "Focused on database queries and data analysis, capable of understanding business needs, building SQL queries, analyzing data and providing insights",
      },
      knowledgeGraphExpert: {
        name: "Knowledge Graph Expert",
        description:
          "Focused on knowledge graph queries and relationship analysis, capable of exploring entity relationships, discovering hidden connections and building knowledge networks",
      },
      documentAssistant: {
        name: "Document Assistant",
        description:
          "Focused on document retrieval and content organization, capable of quickly locating documents, extracting key information and generating summaries",
      },
    },
  },
  settings: {
    ...
    enableMemoryDesc:
      "When enabled, the system will record your conversation history and automatically recall relevant content in future conversations to provide more personalized answers.",
    autoCheckUpdate: "Auto Download Updates",
    autoCheckUpdateDesc:
      "When enabled, automatically check and download the latest version in the background.",
    memoryRequiresNeo4j:
      "Memory feature requires Neo4j graph database. Please configure and enable Neo4j (set NEO4J_ENABLE=true) before enabling this feature.",
    ...
    weknoraCloud: {
      title: "WeKnora Cloud",
      description:
        "Configure WeKnora Cloud APPID and APPSECRET credentials. Credentials are used for model services and document parsing engine.",
      viewDocs: "View Docs",
      unconfigured:
        "Credentials not configured. Please fill in APPID and APPSECRET.",
      configured: "Credentials configured and working.",
      expired: "WeKnora Cloud credentials expired",
      expiredDefault:
        "Encryption key changed after service restart. Saved credentials cannot be decrypted. Please re-enter credentials.",
      ...
      credentialUnconfigured:
        "WeKnoraCloud credentials not configured. Please set up APPID and APPSECRET first.",
      checkingStatus: "Checking credential status...",
      goToSettings: "Go to Settings",
      modelHintConfigured:
        "WeKnoraCloud credentials configured. See supported models in",
    ...
    configureKbModels:
      "Configure models and document splitting parameters for this knowledge base",
    manageSystemModels:
      "Manage and update system models and service configurations",
    ...
    parser: {
      ...
      retry: "Retry",
      noEngineDetected:
        "No parser engine detected. Please ensure the DocReader service is running properly.",
      disconnected: "Disconnected",
      connected: "Connected",
      available: "Available",
      unavailable: "Unavailable",
      builtinDesc:
        "DocReader built-in parser engine (docx/pdf/xlsx and other complex formats)",
      currentAddr: "Current",
      envVarHint:
        "To modify, set environment variables DOCREADER_ADDR and DOCREADER_TRANSPORT (grpc/http), then restart the service.",
    ...
    storage: {
      ...
      description:
        "Configure document and image storage. Set engine parameters here; knowledge bases only select which engine to use.",
      loading: "Loading...",
      retry: "Retry",
      defaultEngine: "Default Engine",
      defaultEngineDesc:
        "The default storage engine when creating new knowledge bases",
      engineLocal: "Local",
      ...
      localDesc:
        "Store files on the server local filesystem, suitable for single-node deployment only.",
      available: "Available",
      ...
      minioDesc:
        "S3-compatible self-hosted object storage, suitable for private networks and private cloud deployment.",
      minioDocker: "Docker Deployment",
      minioRemote: "Remote MinIO",
      detected: "Detected",
      notDetected: "Not Detected",
      minioDockerDetected:
        "Docker-deployed MinIO environment variables detected. Connection info is provided by env vars, no manual input needed.",
      minioDockerNotDetected:
        "MinIO environment variables (MINIO_ENDPOINT, etc.) not detected. Please verify your Docker Compose configuration.",
      minioRemoteHint:
        "Connect to a remote MinIO service. Manual connection info required.",
      cosTitle: "Tencent Cloud COS",
      cosDesc:
        "Tencent Cloud Object Storage, suitable for public cloud deployment with CDN acceleration.",
      ...
      tosDesc:
        "Volcengine Object Storage Service (TOS), suitable for public cloud deployment.",
      tosAccessKeyPlaceholder: "Volcengine Access Key",
      tosSecretKeyPlaceholder: "Volcengine Secret Key",
      s3Title: "AWS S3",
      s3Desc:
        "AWS S3 and S3-compatible object storage services, suitable for public cloud deployment.",
      s3AccessKeyPlaceholder: "AWS Access Key",
      s3SecretKeyPlaceholder: "AWS Secret Key",
      ks3Title: "Kingsoft Cloud KS3",
      ks3Desc:
        "Kingsoft Cloud Object Storage Service (KS3), suitable for public cloud deployment.",
      ...
      obsDesc:
        "Huawei Cloud Object Storage Service (OBS), suitable for public cloud deployment.",
      ...
      ossDesc:
        "Alibaba Cloud Object Storage Service (OSS), suitable for public cloud deployment.",
  ...
  webSearchSettings: {
    ...
    description:
      "Configure web search so answers can include up-to-date information from the internet.",
    // Provider entity management
    providersTitle: "Search Engine Providers",
    addProvider: "Add Provider",
    editProvider: "Edit Provider",
    noProviders:
      'No search engine providers configured. Click "Add Provider" to get started.',
    ...
    setAsDefaultDesc:
      "This provider will be used by default when an agent doesn't specify one",
    // Search behavior
    searchBehaviorTitle: "Search Behavior",
    defaultProviderLabel: "Default Provider",
    defaultProviderDescription:
      "Select the default search provider for agents that do not specify their own.",
    ...
    proxyUrlPlaceholder:
      "e.g. http://proxy.example.com:3128 (optional; http/https only)",
    proxyUrlHelp:
      "Use when outbound access to the search API requires a proxy; leave empty to rely on HTTP_PROXY/HTTPS_PROXY environment variables.",
    apiKeyLabel: "API Key",
    ...
    includeDateDescription:
      "Include publish date information in search results",
    compressionLabel: "Compression Method",
    compressionDescription:
      "Choose how to compress content from search results",
    compressionNone: "No Compression",
    compressionSummary: "LLM Summary",
    blacklistLabel: "URL Blacklist",
    blacklistDescription:
      "Exclude specific domains or URLs from search results. One per line. Supports wildcards (*) and regular expressions (/pattern/).",
  ...
  vectorStoreSettings: {
    ...
    description:
      "Register and manage vector database instances for knowledge base search.",
    ...
    emptyDesc:
      'No vector databases configured. Click "Add Database" to get started.',
    ...
    testing: "Testing...",
    immutableNotice:
      "Engine type, connection, and index settings cannot be changed after creation.\nTo change these, delete and recreate.",
    ...
    validation: {
      ...
      indexNamePattern:
        "Must start with a letter. Only letters, numbers, underscore, and hyphen allowed (max 128)",
    },
    toasts: {
  ...
  chatHistorySettings: {
    ...
    description:
      "Configure chat history knowledge base to automatically index conversation messages for semantic search",
    enableLabel: "Enable Message Indexing",
    enableDescription:
      "When enabled, new conversation messages will be automatically indexed into the knowledge base for vector search",
    embeddingModelLabel: "Embedding Model",
    embeddingModelDescription:
      "Select the embedding model for vectorizing chat messages",
    embeddingModelLocked:
      "Messages have been indexed; the embedding model cannot be changed (clearing indexed data is required)",
    ...
    statsNotConfiguredDesc:
      "Enable and select an embedding model to start auto-indexing conversation messages",
    toasts: {
  ...
  retrievalSettings: {
    ...
    description:
      "Configure global retrieval parameters for knowledge search and message search",
    embeddingTopKLabel: "Vector Search Top K",
    embeddingTopKDescription:
      "Maximum number of results returned by vector search",
    vectorThresholdLabel: "Vector Similarity Threshold",
    vectorThresholdDescription:
      "Minimum similarity score for vector search (0-1, higher is more precise)",
    ...
    rerankThresholdDescription:
      "Minimum score threshold for reranking (-10 to 10)",
    rerankModelLabel: "Rerank Model",
    rerankModelDescription: "Select the model for reranking search results",
    rerankModelRequired:
      "Please select a Rerank model. Search requires this model to rerank results.",
    toasts: {
  ...
  graphSettings: {
    ...
    description:
      'Configure entity-relationship extraction to automatically build a knowledge graph from text (note: this is different from the "page-link graph" inside the Wiki — that one shows references between Wiki pages, while this one is an LLM-extracted entity-relationship graph)',
    enableLabel: "Enable Entity-Relationship Extraction",
    enableDescription:
      "Automatically extract entities and relationships from text when enabled",
    tagsLabel: "Relationship Types",
    tagsDescription:
      "Define relationship type tags to extract, separated by commas",
    tagsPlaceholder:
      "Enter relationship types, e.g., works_at, colleague, friend",
    generateRandomTags: "Generate Random Tags",
    sampleTextLabel: "Sample Text",
    sampleTextDescription:
      "Sample text for testing entity-relationship extraction",
    sampleTextPlaceholder:
      "Enter text containing entities and relationships...",
    ...
    extractActionsDescription:
      "Perform entity-relationship extraction or manage sample data",
    ...
    disabledWarning:
      "Knowledge graph database is not enabled, entity-relationship extraction will not be available",
  ...
  initialization: {
    ...
    baseUrl: "Base URL",
    baseUrlPlaceholder:
      "E.g.: https://api.openai.com/v1, remove /chat/completions from the end of URL",
    ...
    embeddingWarning:
      "Knowledge base already has files, cannot change embedding model configuration",
    dimension: "Dimension",
    ...
    testDescription:
      "Upload an image to test the model's image description and text recognition functions",
    ...
    systemWillExtract:
      "The system will extract corresponding entities and relations from the text according to the selected relation types",
    extractionExample: "Extraction Example",
    sampleText: "Sample Text",
    sampleTextPlaceholder:
      'Enter text for analysis, e.g.: "Red Mansion", also known as "Dream of the Red Chamber", is one of the four great classical novels of Chinese literature, written by Cao Xueqin during the Qing Dynasty...',
    generateRandomText: "Generate Random Text",
    ...
    waitForDownloads:
      "Please wait for all Ollama models to finish downloading before updating configuration",
    ...
    knowledgeBaseSettingsUpdateSuccess:
    ...
    updateKnowledgeBaseInfoFailed:
      "Failed to update knowledge base basic information",
    knowledgeBaseIdMissingCannotSave:
      "Knowledge base ID is missing, cannot save configuration",
    operationFailedCheckNetwork:
      "Operation failed, please check network connection",
    imageUploadSuccess: "Image uploaded successfully, testing can begin",
    multimodalConfigIncomplete:
      "Multimodal configuration incomplete, please complete multimodal configuration before uploading images",
    ...
    pleaseEnterLLMModelConfig:
      "Please enter LLM large language model configuration",
    ...
    extractionFailedCheckNetwork:
      "Extraction failed, please check network or text format",
    generateFailedRetry: "Generation failed, please try again",
    pleaseCheckForm: "Please check form correctness",
    detectionSuccessful:
      "Detection successful, dimension automatically filled as",
    ...
    knowledgeBaseNameLength:
      "Knowledge base name length must be 1-50 characters",
    knowledgeBaseDescriptionLength:
      "Knowledge base description cannot exceed 200 characters",
    ...
    dimensionMustBeInteger:
      "Dimension must be a valid integer, usually 768, 1024, 1536, 3584, etc.",
    ...
    knowledgeBaseSettingsModeMissingId:
      "Knowledge base settings mode missing ID",
    ...
    chunkSizeDesc:
      "Size of each text chunk. Larger chunks preserve more context but may reduce search accuracy.",
    chunkOverlapDesc:
      "Number of characters overlapping between adjacent chunks. Helps maintain context at chunk boundaries.",
  ...
  inviteRegister: {
    ...
    invalidBody:
      "Ask your inviter to send a new link, or sign in with an existing account.",
  ...
  auth: {
    ...
    registerSuccess:
      "Registration successful! The system has created an exclusive tenant for you, please login",
    registerFailed: "Registration failed",
    subtitle:
      "Document understanding and semantic search framework based on large models",
    registerSubtitle:
      "The system will create an exclusive tenant for you after registration",
    emailPlaceholder: "Enter email address",
    passwordPlaceholder:
      "Enter password (8-32 characters, including letters and numbers)",
    ...
    forgotPasswordNotAvailable:
      "Password recovery function is temporarily unavailable, please contact administrator",
  },
  authStore: {
    errors: {
  ...
  mentionDetail: {
    readOnlyFromAgent:
      "Read-only in this conversation; not shown in Knowledge Base list",
    faqCount: "{count} Q&A entries",
    kbCount: "{count} documents",
    belongsToKb: "Knowledge base: ",
    belongsToOrg: "Space: ",
    noCompatibleKbForAgent:
      "This agent's tools don't match any knowledge base's capabilities in scope, so nothing can be referenced.",
  },
  file: {
    upload: "Upload File",
    uploadSuccess: "File uploaded successfully",
  ...
  manualEditor: {
    ...
    warning: {
      ...
      contentTooShort:
        "Content is too short. Please add more information before publishing",
    },
    success: {
    ...
    form: {
      ...
      contentPlaceholder:
        "Supports Markdown. Use # headings, lists, code blocks, etc.",
    },
    noDocumentKnowledgeBases:
      "No document-type knowledge bases available. Please create one first",
    status: {
  ...
  input: {
    ...
    placeholderWithContext:
      "Enter your question, will answer based on selected knowledge bases/files above",
    placeholderWebOnly: "Enter your question, will answer with web search",
    placeholderKbAndWeb:
      "Enter your question, will answer based on knowledge base and web search",
    ...
    agentNotReadyTooltip:
      "Agent is not ready. Please finish configuration first.",
    ...
    goToSettings: "Go to settings →",
    customAgentNotReadyTooltip:
      "Agent is not ready. Please finish configuration first.",
    customAgentNotReadyDetail:
      "Agent is not ready. Please configure the following: {reasons}",
    ...
    builtinAgentNotReadyDetail:
      'Built-in agent "{agentName}" is not ready. Please configure: {reasons}',
    ...
    messages: {
      ...
      webSearchNotConfigured:
        "Web search engine is not configured. Please configure a provider and credentials in settings.",
      webSearchEnabled: "Web search enabled",
      webSearchDisabled: "Web search disabled",
      sessionMissing: "Session ID does not exist",
      messageMissing:
        "Unable to get message ID. Please refresh the page and try again.",
    ...
    webSearchForcedByAgent:
      "Web search is enabled by the current agent and cannot be turned off",
    kbLockedByAgent:
      "Knowledge base configuration is locked by the current agent",
  ...
  knowledgeList: {
    ...
    subtitle:
      "Manage and organize your knowledge bases, supporting document-based and FAQ-based knowledge bases",
    myKnowledgeBases: "My Knowledge Bases",
    ...
    uninitializedBanner:
      "Some knowledge bases are not initialized. Configure model information in settings before adding documents.",
    emptyShared:
      "No collaborative knowledge bases yet. Join a shared space to access knowledge bases from others.",
    empty: {
      title: "No knowledge bases yet",
      description:
        'Click "Create Knowledge Base" in the top-right corner to add your first one.',
      sharedTitle: "No shared knowledge bases",
      sharedDescription:
        "You can join a shared space or request others to share knowledge bases with you",
      favoritesTitle: "No favorites yet",
      favoritesDescription:
        "Star a knowledge base from its card to add it here",
      recentsTitle: "Nothing here yet",
      recentsDescription:
        "Knowledge bases you recently opened will show up here",
    },
    delete: {
    ...
    uploadProgress: {
      ...
      completedDetail:
        "All {total} files uploaded. Refreshing list to show parsing status...",
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      typeFAQ: "FAQ Q&A",
      typeDescription:
        "FAQ suits structured Q&A datasets; document type supports file parsing and chunking; Wiki type auto-builds interlinked knowledge pages via LLM.",
    ...
    wiki: {
      ...
      maxPagesTip:
        "Maximum number of pages to create/update per ingest (0 = no limit)",
      extractionGranularityLabel: "Extraction Granularity",
      extractionGranularityTip:
        "Controls how many Wiki entities/concepts are extracted per document. Finer = tighter index, coarser = more comprehensive",
      granularityFocused: "Focused",
      granularityStandard: "Standard",
      granularityExhaustive: "Exhaustive",
      granularityFocusedHint:
        "Extract only the document\u2019s main subjects (e.g. a resume yields the person and their projects). Cleanest, may miss secondary entities.",
      granularityStandardHint:
        "Main subjects plus secondary entities/concepts that receive substantial discussion. Skips name-dropped terms. Recommended default.",
      granularityExhaustiveHint:
        "Extract every named entity and concept, including passing mentions of stacks/tools. Use when the KB serves as a glossary.",
    },
    indexing: {
      title: "Indexing Strategy",
      description:
        "Configure document processing pipelines. Each indexing method can be enabled or disabled independently.",
      searchTitle: "RAG Search",
      searchDesc:
        "Chunk, vectorize and keyword-index documents for hybrid retrieval",
      wikiTitle: "Wiki Knowledge Base",
      wikiDesc:
        "Auto-generate interlinked wiki pages to build a structured knowledge system",
      graphTitle: "Knowledge Graph",
      graphDesc:
        "Extract entities and relationships to build a knowledge graph for graph-based retrieval",
      ...
      rebuildConfirmBody:
        "Indexing strategy has changed. Re-process {count} existing documents? This may take some time.",
    ...
    wikiBrowser: {
      ...
      tabGraph: "Graph",
      tabGraphTip:
        'A graph of links between Wiki pages (page-link graph). This is NOT the same as the LLM-extracted entity-relationship Knowledge Graph configured under "KB Settings → Knowledge Graph".',
      ...
      emptyDesc:
        "Upload documents with Wiki enabled to auto-generate knowledge pages",
      ...
      cardOverviewHintTruncated:
        "Double-click any node to focus on its subgraph",
      ...
      neighborsProgress:
        "Showing {visible} of {total} neighbors ({hidden} not loaded)",
      neighborsAllShown:
        "All {total} neighbors are already on the canvas (click Expand to focus on this node’s subgraph)",
      neighborsNone: "This page has no linked neighbors",
      neighborsCenterUnreachable:
        "Showing {visible} of {total} neighbors ({hidden} unreachable: dead links, filtered, or deleted)",
      ...
      issueFixPromptSingle:
        "Please fix the issue (ID: {id}) on page [[{slug}]].",
      issueFixPromptAutoStart:
        "Please fix the following issues on page [[{slug}]]:",
    ...
    share: {
      description:
        "Share the knowledge base with spaces so members can access and use it",
      addShare: "Share",
    ...
    messages: {
      ...
      indexModeRequired:
        "Please select an indexing mode for FAQ knowledge bases",
    ...
    document: {
      ...
      subtitle:
        "Click or drag-and-drop to upload documents; multiple formats are parsed automatically with intelligent chunking for a searchable knowledge base",
    },
    faq: {
      title: "FAQ Configuration",
      subtitle:
        "Manage FAQ entries with batch import, edit, and search testing",
      description:
        "Configure indexing strategy and guidance for FAQ-style knowledge bases",
      indexModeLabel: "Indexing Mode",
      indexModeDescription:
        "Question-only indexing improves precision, question+answer improves recall.",
      questionIndexModeLabel: "Question Indexing Mode",
      questionIndexModeDescription:
        "Combined: Standard and similar questions are indexed together. Separate: Each question is indexed independently for more precise retrieval but requires more storage.",
      entryGuide:
        "Each FAQ entry contains a primary question, similar questions, negative examples, and multiple answers. Manage them in the FAQ knowledge base detail view.",
      ...
      standardQuestionDesc:
        "Set the standard phrasing of the question — this is the most common way users ask it.",
      answers: "Answers",
      answersDesc:
        "Provide complete and accurate answer content. Multiple answers can be added to cover different scenarios.",
      similarQuestions: "Similar Questions",
      similarQuestionsDesc:
        "Add questions with the same meaning but different phrasing to help the system better match user queries.",
      negativeQuestions: "Negative Examples",
      negativeQuestionsDesc:
        "Add questions that should not match this answer, to exclude false positives.",
      ...
      answerPlaceholder:
        "Enter answer content, supports multi-line text, press Ctrl+Enter or click button to add",
    ...
    models: {
      ...
      llmLabel: "LLM Model",
      llmDesc:
        "Large language model used for summarization and abstract generation (optional)",
      ...
      embeddingLocked:
        "Knowledge base already has files. Embedding model cannot be modified",
    ...
    chunking: {
      ...
      description:
        "Controls how uploaded documents are split before embedding. Defaults work for most cases — tune only when retrieval quality is off.",
      sizeLabel: "Chunk Size",
      sizeDescription:
        "Maximum characters per chunk (100–4000). Default 512 ≈ 100–130 English tokens. Smaller for FAQs (200–400), larger for narrative documents (1000–2000).",
      characters: "characters",
      overlapLabel: "Chunk Overlap",
      overlapDescription:
        "Characters shared between adjacent chunks (0–500). Default 80 ≈ 15% of size — sweet spot per current research. Use 0 for FAQs/structured data, 150–200 for long-form narratives.",
      separatorsLabel: "Separators",
      separatorsDescription:
        "Characters or strings the splitter prefers when cutting. Higher-priority separators are tried first; the default order favors paragraph → sentence → punctuation breaks.",
...
\
      ...
      parentChunkSizeDescription:
        "Size of the context chunk returned to the LLM (512–8192). Default 4096 ≈ 1000 English tokens, fits comfortably in any modern LLM context window.",
      childChunkSizeLabel: "Child Chunk Size",
      childChunkSizeDescription:
        "Size of the embedded chunk used for vector match (64–2048). Default 384 ≈ 80 tokens — sweet spot for sentence-transformer / BGE-style embedders.",
      strategyLabel: "Chunking Strategy",
      strategyDescription:
        "Choose how documents are split into chunks. The Automatic mode profiles each document and picks the best strategy.",
      strategyPlaceholder:
      ...
      strategies: {
        auto: {
          label: "Automatic",
          tooltip:
            "A document profiler picks between heading-aware, structure-aware and length-based splitting per upload.",
        },
        heading: {
          label: "Heading-aware",
          tooltip:
            "Splits at Markdown heading boundaries (#, ##, ###); each chunk carries its heading path. Best for well-structured Markdown.",
        },
        heuristic: {
          label: "Structure-aware",
          tooltip:
            "Splits on detected structural cues: page-breaks, numbered sections, multilingual chapter markers (DE/EN/ZH), all-caps titles. Ideal for PDFs without Markdown headings.",
        },
        legacy: {
          label: "Length-based",
          tooltip:
            "Ignores structure; splits recursively by character count and separators — the original behavior. Use when the structure-aware strategies misbehave on your content.",
        },
      },
      overlapWarning:
      ...
      languagesDescription:
        "Restricts heuristic patterns to the chosen languages (DE/EN/ZH). Empty = auto-detect from sample. Set explicitly for homogeneous corpora to avoid false-positive matches across languages.",
      ...
      debug: {
        ...
        samplePlaceholder:
          "Paste a Markdown / plain-text snippet to see how the current configuration would chunk it…",
        ...
        fallbackWarning:
          "Strategy chain fell through — content does not split intelligently with current settings",
        profile: {
          lines: "lines",
          chars: "chars",
    ...
    multimodal: {
      ...
      description:
        "Configure image content understanding for parsing and retrieving non-text content like images",
    },
    asr: {
    ...
    advanced: {
      ...
      questionGeneration: {
        ...
        description:
          "Generate related questions for each chunk using LLM during document parsing to improve retrieval recall. Enabling this will increase document parsing time.",
        countLabel: "Question Count",
        countDescription:
          "Number of questions to generate per document chunk (1-10)",
      },
      multimodal: {
        label: "Multimodal Feature",
        description:
          "Enable understanding of multimodal content such as images",
        vllmLabel: "VLLM Vision Model",
        vllmDescription:
          "Vision-language model required for multimodal understanding",
        ...
        storageTypeDescription:
          "Choose the storage solution for multimodal files (MinIO or Tencent Cloud COS)",
        storageTypeOptions: {
          minio: "MinIO",
          cos: "Tencent Cloud COS",
        },
        minioDisabledWarning:
          "MinIO is not enabled. Automatically switched to Tencent Cloud COS. To use MinIO, please enable it in system configuration first.",
        minio: {
          bucketLabel: "Bucket Name",
          bucketDescription: "Name of the MinIO bucket (required)",
          bucketPlaceholder: "Select or enter bucket name",
          bucketHint:
            "Select an existing bucket with public read access, or enter a new name to create automatically",
          policyLabels: {
            public: "Public Read",
            private: "Private",
            custom: "Custom",
        ...
        cos: {
          ...
          regionLabel: "Region",
          regionDescription:
            "Region where the COS bucket is located (required)",
  ...
  chat: {
    ...
    referencesDocAndWebCount:
      "Referenced {docCount} document(s) and {webCount} web page(s)",
    referenceChunkCount: "{count} chunk(s)",
    fallbackHint:
      "No relevant content found in knowledge base. Above is a direct response from the model.",
    channelWeb: "Web",
    channelApi: "API",
    channelIm: "IM",
  ...
  tenant: {
    ...
    systemInfo: "System Information",
    viewSystemInfo:
      "View system version and user account configuration information",
    version: "Version",
    ...
    apiKey: "API Key",
    keepApiKeySafe:
      "Please keep your API Key safe, do not disclose it in public places or code repositories",
    ...
    useApiKey:
      "Use your API Key to start development, view complete API documentation and code examples.",
    ...
    api: {
      ...
      urlLabel: "API URL",
      urlDescription:
        "Base path for REST API requests; append the specific endpoint when calling.",
      ...
      resetConfirmBody:
        "After reset, the old API Key is revoked immediately. Every app, SDK, and script using the old key must switch to the new key to keep working. This action cannot be undone.",
  ...
  system: {
    ...
    sectionDescription:
      "View system version information and user account configuration",
    loadingInfo: "Loading information...",
    retry: "Retry",
    ...
    dbMigrationFailedDesc:
      "The startup database migration did not complete successfully. Some tables or indexes may be missing, which can break Wiki ingest, the knowledge graph, and other features. Check the troubleshooting guide below first; if the issue persists, report it via the link.",
    ...
    globalSettings: {
      ...
      description:
        "Platform-wide runtime configuration. Saves take effect immediately for every tenant. Visible and editable by system administrators only.",
      loading: "Loading...",
      ...
      keyLabels: {
        ...
        tenant: {
          ...
          default_storage_quota_gb:
            "Default storage quota for new tenants (GB)",
        },
      },
      enumLabels: {
        auth: {
      ...
      reset: {
        label: "Reset",
        tooltip:
          "Clear the UI override and fall back to the environment variable or the built-in default",
        confirmBtn: "Confirm reset",
        confirmBody:
          'Reset "{label}"? This deletes the database override and falls back to the environment variable or the built-in default.',
      ...
      bulkApply: {
        ...
        tooltip:
          "Saving the value only affects new tenants by default; click here to also overwrite every existing tenant.",
        confirmBtn: "Confirm apply",
        confirmBody:
          "Overwrite the storage quota of every existing tenant to {value} GB. Tenants whose quota was tuned manually by operations will also be overwritten. Continue?",
  ...
  model: {
    ...
    editor: {
      ...
      displayNameDesc:
        "Used only in the UI. Runtime calls still use the model name above.",
      ...
      customHeadersDesc:
        "Extra HTTP headers appended to requests to the remote model API (e.g. for enterprise gateway auth or tracing). Reserved headers like Authorization / Content-Type are ignored.",
      ...
      supportsVisionDesc:
        "Whether the model accepts image and multimodal input",
      dimensionHint:
        'Model selected. Click "Detect Dimension" to fetch the vector dimension automatically.',
      ...
      connectionConfigError:
        "Connection failed, please check the configuration",
      ...
      ollamaUnavailable:
        "Ollama service is unavailable, local models cannot be selected",
      ollamaNotSupportRerank:
        "Ollama does not support ReRank models, please use a remote API instead",
      ...
      providers: {
        ...
        minimax: {
          label: "MiniMax",
          description:
            "MiniMax-M2.7, MiniMax-M2.7-highspeed, MiniMax-M2.5, etc.",
        },
        mimo: {
          label: "MiMo",
  ...
  theme: {
    theme: "Theme",
    themeDescription:
      "Choose the display theme for the interface, supports automatic switching with system settings",
    light: "Light",
    dark: "Dark",
  ...
  font: {
    ...
    uiFontDescription:
      "Font used for menus, body text, buttons, and most UI text",
    monoFont: "Code Font",
    monoFontDescription:
      "Used for code blocks, terminal commands, API keys, file paths and other technical text. Every character has the same width so you can tell 0 from O and 1 from l.",
    ...
    fontSize: "Font Size",
    fontSizeDescription:
      "Scales the entire interface (text, icons, spacing) and applies immediately",
    size: {
      small: "Small",
      normal: "Normal",
      large: "Large",
  ...
  platform: {
    ...
    description:
      "Making complex document understanding and precise retrieval simple",
  ...
  agentSettings: {
    ...
    description:
      "Configure the default behavior and parameters for the AI Agent. These settings apply to all chats with Agent mode enabled.",
    modelRecommendation: {
      title: "Model Recommendation",
      content:
        "For better Agent experience, we recommend using large language models with FunctionCalling support and long context windows, such as deepseek-v3.1-terminus",
    },
    status: {
      label: "Agent Status",
      ready: "Ready",
    ...
    systemPrompt: {
      ...
      disabledHint:
        "Currently using the default prompt. Enable custom to apply the content below.",
      placeholder:
        "Enter the system prompt, or leave blank to use the default...",
      tabHint:
        "Unified system prompt using {'{{'}web_search_status{'}}'} placeholder for dynamic web search behavior",
      tabHintDetail:
        "Unified system prompt (leave empty for system default, use {'{{'}web_search_status{'}}'} placeholder to dynamically control web search behavior)",
    },
    reset: {
    ...
    globalConfigNotice:
      "These are global default settings. New agents will inherit these settings. You can also configure each agent individually in the agent list.",
    loadConfigFailed: "Failed to load Agent configuration",
    loadModelsFailed: "Failed to load model list",
    errors: {
      selectThinkingModel:
        "Please select a thinking model before enabling Agent mode",
    ...
    toasts: {
      ...
      autoDisabled:
        "Agent configuration incomplete. Agent mode has been disabled automatically",
    },
  },
  conversationSettings: {
    description:
      "Configure default behavior and parameters for conversation modes, including prompts for Agent and normal modes",
    ...
    models: {
      description:
        "Manage thinking/chat models and re-rank models for both Agent and normal modes",
      chatGroupLabel: "Thinking / Chat Models",
      chatGroupDesc:
        "Includes Agent reasoning/planning model and the default chat/summary model for normal mode",
      chatModel: {
      ...
      rerankGroupDesc:
        "Includes Agent rerank model and the default rerank model for normal mode",
    },
    thresholds: {
      description:
        "Tune retrieval and re-ranking thresholds to balance accuracy and performance",
    },
    maxRounds: {
    ...
    advanced: {
      description:
        "Configure query rewrite, fallback strategy and other advanced settings",
    },
    rewritePrompt: {
    ...
    contextTemplate: {
      ...
      descWithDefault:
        "Prompt template for generating answers based on retrieval results in normal mode (leave empty for system default)",
      placeholder: "Enter the prompt template for retrieval result summary...",
      custom: "Custom template",
      disabledHint:
        "Currently using the default summary prompt. Enable custom to edit below.",
    },
    systemPrompt: {
      label: "System Prompt",
      desc: "System-level prompt for normal mode conversations",
      descWithDefault:
        "System-level prompt for normal mode conversations (leave empty for system default)",
      placeholder: "Enter the system prompt...",
      custom: "Custom prompt",
      disabledHint:
        "Currently using the default prompt. Enable custom to edit below.",
    },
    temperature: {
      label: "Temperature",
      desc: "Controls randomness in outputs. 0 is most deterministic; 1 is most random",
  ...
  mcpSettings: {
    title: "MCP Services",
    description:
      "Manage external MCP (Model Context Protocol) services for tools/resources in Agent mode",
    ...
    deleteConfirmBody:
      'Delete MCP service "{name}"? This action cannot be undone.',
    unnamed: "Unnamed",
    builtin: "Built-in",
  },
  // New: Model Settings
  modelSettings: {
    ...
    description:
      "Manage different types of AI models, including local Ollama and remote APIs",
    typeShort: {
      chat: "Chat",
      embedding: "Embedding",
      rerank: "ReRank",
    ...
    builtinModels: {
      ...
      description:
        "Built-in models are visible to all tenants. Sensitive information is hidden, and they cannot be edited or deleted.",
  ...
  ollamaSettings: {
    ...
    address: {
      ...
      failed:
        "Connection failed. Please check whether Ollama is running or the URL is correct",
    },
    download: {
  ...
  organization: {
    ...
    inviteCodeTip:
      "Share this invite code with others to let them join your space",
    ...
    rbac: {
      ...
      needTenantAdminTip:
        "This action requires the admin role (or higher) in the current tenant. Please contact the tenant owner.",
      cannotCreate: "Your tenant role is insufficient to create a shared space",
      cannotJoin:
        "Your tenant role is insufficient to join or request to join a shared space",
      cannotManage:
        "Your tenant role is insufficient to manage this shared space",
    },
    join: {
      title: "Join Space",
      ...
      searchSpacesDesc:
        "Browse or search spaces that are open for discovery; join without an invite code",
    ...
    invite: {
      ...
      inputDesc:
        "Enter the invite code (or paste from an invite link) to view the space and join",
      previewAction: "View",
      primaryJoin: "Join",
    ...
    leaveConfirmMessage:
      'Are you sure you want to leave "{name}"? You will lose access to shared knowledge bases.',
    ...
    deleteConfirmMessage:
      'Are you sure you want to delete "{name}"? All members will be removed. This action cannot be undone.',
    ...
    detail: {
      ...
      shareKBTip:
        "Go to knowledge base list, select a knowledge base and click share to share it to this space",
    },
    settings: {
      ...
      membersDesc:
        "View and manage space members and their roles. Each member represents a tenant — all users in the same tenant share access to this space.",
      sharedDesc: "View all knowledge bases shared to this space",
      noSharedKB: "No shared knowledge bases yet",
      noSharedKBTip:
        "Knowledge base owners can share their knowledge bases to this space in KB settings",
      sharedAgents: "Shared Agents",
      noSharedAgents: "No shared agents yet",
      sharedAgentsDesc:
        "Agents shared to this space; members can use them in chat",
      sharedAgentsKbHint:
        "Knowledge bases linked to an agent are only available (read-only) when members use that agent in a conversation (via {'@'}). They do not appear in the Knowledge Base list. To let members see or edit a knowledge base in the list, share that knowledge base to this space separately.",
      sharedAgentsKbHintShort:
        "Agent-linked knowledge is read-only in chat; share the KB to this space if members should see or edit it in the list.",
      noSharedAgentsTip:
        "Admins can share agents to this space from agent settings",
      sharePermissionLabel: "Space permission",
      myPermissionLabel: "My actual permission",
      permissionCalcFormula:
        "Space permission is what was set when the KB was shared to this space; my actual permission = min(space permission, my role in this space)",
      permissionCalcTip:
        "My actual permission = min(space permission, my role in this space). As a viewer in the space, I have at most read-only on this KB; as editor or admin, my permission is capped by the space permission.",
      ...
      inviteLinkValidityDesc:
        "Validity period for newly generated invite links",
      validity1Day: "1 day",
      ...
      removeShareConfirm:
        'Remove "{name}" from this space? Members will no longer have access to this knowledge base.',
      removeAgentShareConfirm:
        'Remove "{name}" from this space? Members will no longer have access to this agent.',
      removeShareSuccess: "Removed from space",
      removeShareFailed: "Failed to remove, please try again",
      requireApproval: "Require Approval",
      requireApprovalDesc:
        "When enabled, new members need admin approval to join",
      searchable: "Open for search",
      searchableDesc:
        'When enabled, this space appears in the "Join Space" search list; others can search and request to join without an invite code',
      memberLimit: "Member limit",
      memberLimitDesc:
        "No new members can be added when the limit is reached; 0 means unlimited",
    ...
    editor: {
      ...
      permissionsDesc:
        "Understand the permission scope of different roles for knowledge bases and agents in the space",
      permissionFeature: "Permission Feature",
      fullAccess: "Full Access",
      editAccess: "Edit Access",
      viewAccess: "View Only",
      adminPerm1:
        "Manage space settings, members, and knowledge base & agent sharing",
      ...
      ownerNote:
        "As the space creator, you will automatically become an admin with full permissions.",
      joinTitle: "Join Space",
      joinDesc:
        "Join an existing space with an invite code to access shared knowledge bases and agents",
      joinIllustration:
        "Enter the invite code provided by the space admin to join",
      inviteCodeTip:
        "The invite code is generated by space admins, please ask them for it",
    ...
    upgrade: {
      ...
      reasonPlaceholder:
        "Please briefly explain why you need higher permissions...",
    ...
    addMember: {
      ...
      tipTenant:
        "Membership is at the tenant level: once a tenant joins, all of its users share access to this space. Results below are deduplicated by tenant.",
      ...
      searchTenantHint:
        "Type at least 2 characters; results are deduplicated by tenant and exclude tenants already in this space",
    ...
    share: {
      ...
      permission: "Permission",
      permissionTip:
        "Editable permission allows members to modify knowledge base content, Read-only permission only allows search and Q&A",
  ...
  knowledgeSearch: {
    title: "Search",
    subtitle:
      "Semantic search across knowledge bases and chat history to find relevant content",
    ...
    matchCount: "matches",
    emptyHint:
      "Enter keywords to search for relevant content chunks in knowledge bases",
  ...
  kbSettings: {
    ...
    storage: {
      title: "Storage Engine",
      description:
        "Select the file storage engine. This affects how uploaded documents and images within documents are stored. Parameters are configured in global settings.",
      loading: "Loading...",
      engineLabel: "Storage Engine",
      engineDesc:
        "Select the storage engine for this knowledge base. The corresponding engine must be configured in global settings.",
      selectPlaceholder: "Select a storage engine",
      notConfigured: "Not Configured",
      unavailable: "Unavailable",
      lockedHint:
        "This knowledge base already has files. Cannot switch storage engine. To change, please clear all files first.",
      changeWarning:
        "Changing the storage engine only affects newly uploaded files. Existing files will still be read from the original storage engine, but some old files may become inaccessible if their paths cannot be automatically recognized.",
      ...
      engineS3: "AWS S3",
      engineS3Desc:
        "AWS S3 and compatible storage, for public cloud deployment",
      engineOss: "Alibaba Cloud OSS",
      engineOssDesc:
        "Alibaba Cloud Object Storage Service, for public cloud deployment",
      engineKs3: "Kingsoft Cloud KS3",
      engineKs3Desc:
        "Kingsoft Cloud Object Storage Service, for public cloud deployment",
      engineObs: "Huawei Cloud OBS",
      engineObsDesc:
        "Huawei Cloud Object Storage Service, for public cloud deployment",
    },
    parser: {
      title: "Parser Engine",
      description:
        "Select document parser engines for different file types. Unconfigured file types will use the built-in parser.",
      loading: "Loading...",
      noEngineAvailable:
        "No parser engine available, or the document parsing service is not configured.",
      default: "Default",
      unavailable: "Unavailable",
  ...
  agentStream: {
    toolApproval: {
      banner:
        "This MCP tool requires human approval. Review parameters before execution.",
      service: "Service",
      tool: "Tool",
      argsLabel: "Arguments",
    ...
    citation: {
      ...
      chunkId: "Chunk ID",
      noKbForWiki:
        "Unable to identify associated knowledge base. Cannot open Wiki.",
    },
    toolSummary: {
  ...
  agentEditor: {
    builtinHint:
      "This is a built-in agent. Name and description cannot be modified, but configuration parameters can be adjusted.",
    placeholders: {
    ...
    intentPrompts: {
      ...
      sectionDesc:
        "Configure intent-specific system prompts; defaults apply when not customized",
      intentLabel: "Intent",
    ...
    desc: {
      ...
      systemPrompt:
        "Custom system prompt to define the agent behavior and role",
      leaveEmptyDefault: "(leave empty to use system default)",
      contextTemplate:
        "Define how retrieved content is formatted before passing to the model",
      model: "Select the LLM used by the agent",
      temperature:
        "Control output randomness, 0 is most deterministic, 1 is most random",
      ...
      multiTurn:
        "When enabled, historical conversation context will be preserved",
      historyRounds: "Number of recent conversation rounds to keep as context",
      rewrite:
        "Automatically rewrite user questions in multi-turn conversations to resolve references and omissions",
      queryUnderstandModel:
        "Model used for query understanding (rewriting and intent detection). Leave empty to reuse the main chat model.",
      rewriteSystemPrompt:
        "System prompt for question rewriting (leave empty for default)",
      rewriteUserPrompt:
        "User prompt template for question rewriting (leave empty for default)",
      ...
      webSearch:
        "When enabled, the agent can search the internet for information",
      webSearchProvider:
        "Specify a search engine for this agent. Leave empty to use the default.",
      webSearchMaxResults: "Maximum number of results returned per search",
      webFetchEnabled:
        "After reranking, auto-fetch full page content from top web results for better answers",
      webFetchTopN: "Maximum number of web pages to fetch after reranking",
      retrievalSection:
        "Configure knowledge base retrieval and ranking parameters",
      ...
      fallbackStrategy:
        "How to handle when no relevant content is found in the knowledge base",
      fallbackResponse: "Fixed text returned when unable to answer",
      fallbackPrompt:
        "Prompt to guide model response when no answer is found in knowledge base",
    },
    tools: {
      thinking: "Thinking",
      ...
      grepChunksDesc:
        "Quickly locate documents and chunks containing specific keywords",
      knowledgeSearch: "Semantic Search",
      knowledgeSearchDesc:
        "Understand questions and find semantically relevant content",
      ...
      wikiReadSourceDocDesc:
        "Dive into the original documents that a Wiki page is built from",
      wikiFlagIssue: "Flag Wiki Issue",
      wikiFlagIssueDesc:
        "Flag factual errors or merge conflicts on a Wiki page",
      ...
      statusInactive:
        "{count} ticked tool(s) cannot take effect with the current config",
    ...
    im: {
      ...
      description:
        "Connect agent to instant messaging platforms like WeCom, Feishu, Slack, Telegram, DingTalk, Mattermost and WeChat",
      feishu: "Feishu",
      slack: "Slack",
      telegram: "Telegram",
      dingtalk: "DingTalk",
      ...
      dingtalkCardTemplateIdHint:
        "Create an AI Card template at open-dev.dingtalk.com/fe/card to enable streaming output with typewriter effect",
      mattermostConsole: "Mattermost integrations",
      mattermostModeHint:
        "Mattermost only supports Webhook mode (outgoing webhook + bot token).",
      ...
      wecomWSEndpointHint:
        "Optional. For private WeCom deployments, enter a custom WebSocket address. Leave empty to use the default public cloud endpoint. For internal network addresses, add the hostname to the SSRF_WHITELIST env var.",
      wecomAPIBaseURLHint:
        "Optional. For private WeCom deployments, enter a custom API base URL. Leave empty to use the default public cloud endpoint. For internal network addresses, add the hostname to the SSRF_WHITELIST env var.",
      ...
      fileKnowledgeBaseHint:
        "When configured, files sent by users will be automatically saved to this knowledge base",
      sessionMode: "Session Mode",
      sessionModeUser: "Per User (default)",
      sessionModeThread: "Per Thread",
      sessionModeHint:
        "User mode: each person has their own conversation. Use /clear to start fresh. Thread mode: each message thread is a separate conversation. Multiple people can collaborate in the same thread.",
    ...
    agentType: {
      ...
      kbIncompatibleWarn:
        "{count} selected KB(s) are not compatible with this type, please adjust manually.",
    },
    mcp: {
      label: "MCP Services",
    ...
    imageUpload: {
      ...
      sectionDesc:
        "Configure image upload and vision-language model for multimodal conversations",
      label: "Image Upload",
      ...
      storageProviderDesc:
        "Storage engine for uploaded images. Leave empty to use system default",
    ...
    audioUpload: {
      ...
      asrModel: "ASR Model",
      asrModelDesc:
        "Speech recognition model for audio transcription. If not configured, audio files will be passed as placeholders.",
      asrModelPlaceholder: "Select ASR Model",
    },
    faq: {
      title: "FAQ Priority Strategy",
      tooltip:
        "When the knowledge base contains FAQ (Q&A pairs), enable this strategy to prioritize FAQ answers over regular documents",
      enableLabel: "Enable FAQ Priority",
      enableDesc:
        "FAQ answers will be prioritized over regular documents, improving response accuracy",
      thresholdLabel: "Direct Answer Threshold",
      thresholdDesc:
        "When the similarity between the question and FAQ exceeds this value, use the FAQ answer directly",
      boostLabel: "FAQ Score Boost",
      boostDesc:
        "Multiply FAQ relevance scores by this factor to rank them higher",
    },
    dataAnalysis: {
      enableLabel: "Enable Tabular Data Analysis",
      enableDesc:
        "When the retrieved chunks come from a CSV/Excel file, ask the LLM to generate a DuckDB SQL query before answering. This adds one extra LLM call and several seconds of latency, so only enable it when you actually need SQL-style analysis.",
    },
    fallback: {
      fixed: "Fixed Response",
  ...
  datasource: {
    title: "Data Sources",
    description:
      "Configure external data sources to sync content into this knowledge base",
    add: "Add Data Source",
    ...
    delete: "Delete",
    deleteConfirm:
      "Delete this data source? Synced knowledge will not be removed.",
    ...
    noResourcesDesc:
      "The app needs wiki access via a group chat to fetch content",
    noResourcesDesc_notion:
      "The app needs Notion page access permissions to fetch content",
    retryLoadResources: "Retry",
    guideStep1:
      "Create a group chat in Feishu, then add your app as a bot in the group settings",
    guideStep2:
      'Open wiki "Settings" > "Member Settings" > "Add Member", search for the group chat and add it',
    guideStep3:
      'Ensure the group chat role is at least "Can Read", then come back and click Retry',
    guideStep1_notion: "Open the page or database you want to sync in Notion",
    guideStep2_notion:
      'Click the "···" menu at the top right, select "Connect to" or "Add connections"',
    guideStep3_notion:
      "Search and select your Integration app, then come back and click Retry",
    ...
    field: {
      ...
      baseUrlHint:
        "Leave empty to use the Yuque public cloud (https://www.yuque.com). For Yuque Enterprise or self-hosted deployments, enter your company domain (e.g. https://your-company.yuque.com).",
    },
    ...
    prereqStep1Desc_yuque:
      "Sign in to Yuque → avatar → Settings → Token → New Token",
    prereqStep2Brief_yuque: "Grant the token required permissions",
    prereqStep2Desc_yuque:
      "Check at least repo:read and doc:read (read knowledge base and document content)",
    prereqStep3Brief_yuque:
      "(Optional) Enter Base URL for enterprise deployments",
    prereqStep3Desc_yuque:
      "Leave empty for public cloud; for Yuque Enterprise or self-hosted, enter your company domain.",
    prereqOpenConsole_yuque: "Open Yuque Token settings",
    prereqBotBrief: 'Add "Bot" capability to your app',
    prereqBotDesc:
      "Open Platform > Add App Capability > Bot > create version and publish",
    prereqBotLabel:
      '1. Add "Bot" capability to your app (otherwise the app won\'t appear in wiki member search):',
    prereqBotStep1:
      'Open your app in Feishu Open Platform, click "Add App Capability" in the left menu',
    prereqBotStep2: 'Select "Bot" and confirm',
    prereqBotStep3:
      "Create a new version and publish (or test in your test organization)",
    ...
    prereqMemberDesc:
      "Create group chat > add app as bot > add group chat as wiki member",
    prereqMemberLabel:
      "3. Add the app to a wiki space via group chat (wiki cannot search for apps directly):",
    back: "Back",
    next: "Next",
    save: "Save",
  ...
  imOverview: {
    ...
    subtitle:
      "All IM channels connected to agents in this tenant — toggle state or jump to the owning agent",
  ...
  userProfile: {
    title: "User Profile",
    description:
      "View your account info (user ID, username, email, registration time).",
  },
  tenantMember: {
    title: "Members",
    sectionDescription:
      "Invite teammates to the tenant and manage their roles. Only Owner can add or remove members.",
    ...
    remove: {
      ...
      confirmBody:
        "Are you sure you want to remove {name} from this tenant? They will lose access immediately.",
      confirm: "Remove",
    ...
    leave: {
      ...
      confirmBody:
        "You will lose access to all knowledge bases and agents in this tenant. You can be re-invited later.",
      confirm: "Leave",
    ...
    errors: {
      ...
      lastOwner:
        "Cannot demote, remove, or leave as the last Owner. Promote another member to Owner first.",
  ...
  tenantInvitation: {
    ...
    shareLink: {
      ...
      resultBody:
        "Copy the link below and share it via any private channel. It's also saved in the list — you can re-copy or revoke it later.",
      revokeConfirm:
        "Revoking will block anyone who hasn't registered yet from using this link. Generate a new one to re-share.",
    },
    revoke: {
      button: "Revoke",
